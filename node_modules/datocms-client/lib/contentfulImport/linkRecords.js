...
var _default = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref) {
    var datoClient, fieldsMapping, contentfulData, contentfulRecordMap, contentfulAssetsMap, spinner, entries, progress, _ret;

    return regeneratorRuntime.wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            datoClient = _ref.datoClient, fieldsMapping = _ref.fieldsMapping, contentfulData = _ref.contentfulData, contentfulRecordMap = _ref.contentfulRecordMap, contentfulAssetsMap = _ref.contentfulAssetsMap;
                              ...
                              case 4:
                                if (datoField.localized) {
                                  datoNewValue = Object.entries(contentfulItem).reduce(function (innerAcc, _ref3) {
                                    ...
                                    return _objectSpread(_objectSpread({}, innerAcc), {}, _defineProperty({}, locale, datoValueForFieldType(innerValue, datoField)));
                                  }, {});
                                } else {
